  ...
  <footer className="page-footer font-small blue py-2 footerBG">
    ...
    >
      <Row className="p-0 m-0 w-100 d-flex justify-content-around align-items-center">
        ...
        <Col className="col-12 col-md-3 mb-md-0 d-flex justify-content-center align-items-center">
          <div className="d-flex m-0 text-center w-50 justify-content-around justify-content-md-end">
